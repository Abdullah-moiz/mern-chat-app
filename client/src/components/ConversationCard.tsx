...
export default function ConversationCard({_id , name , email } : userData) {
    ...
    return (
        <div onClick={handleClick} className='lg:w-11/12 w-full h-20 bg-gray-50 my-2 flex items-center cursor-pointer rounded px-4 mx-4 hover:bg-indigo-600 hover:text-white justify-start  transition-all duration-700'>
